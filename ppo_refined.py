...
with open("ppo_refined_training_log.csv", "w", newline="") as f:
    writer = csv.writer(f)
...
plt.title("PPO refined (lr=1e-3) on CarRacing-v3: reward over training")
plt.savefig("ppo_refined_reward_plot.png")
plt.close()
...
plt.xlabel("Iteration")
plt.ylabel("Value")
plt.title("PPO refined (lr=1e-3) on CarRacing-v3: losses over training")
plt.legend()
plt.savefig("ppo_refined_loss_plot.png")
plt.close()

print("saved ppo_refined_reward_plot.png and ppo_refined_loss_plot.png", flush=True)
